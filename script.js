...
function initText(dialog, fs, crypto, main) {
    ...
    getEncode(crypto, buttonEncode, text);
    getDecrypt(crypto, buttonDecrypt, text);
...
function getEncode(crypto, buttonEncode, text) {
...
function getDecrypt(crypto, buttonDecrypt, text) {
